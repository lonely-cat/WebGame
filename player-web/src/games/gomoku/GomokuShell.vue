<template>
  <div class="gomoku-shell">
    <section class="hero">
      <div class="hero-copy">
        <p class="eyebrow">Board Game Room Flow</p>
        <h1>Gomoku now runs through distinct room and match screens.</h1>
        <p class="subtitle">
          This route split gives us a reusable multiplayer shell: stage the room first, then move
          into a clean match view once the server starts the game.
        </p>
      </div>
