      ...
      <article class="panel">
        <div class="panel-heading">
          <div>
            ...
            <h2>Sign in for the party room</h2>
          </div>
      ...
      <article class="panel">
        <div class="panel-heading">
          <div>
            ...
            <h2>Assemble the sketch table</h2>
          </div>
      ...
      <article class="panel">
        <div class="panel-heading tight">
          <div>
            ...
            <h2>Room flow first, social mechanics next</h2>
          </div>
        </div>
        <p class="copy">
          Draw and Guess now rides the shared multiplayer room flow. The next steps are drawer
          rotation, secret prompt assignment, stroke sync, and guess submission.
        </p>
        <dl class="stats">
...
watch(inMatch, (value) => {
  if (value) {
    router.push("/games/draw-guess/match");
  }
}, { immediate: true });
</script>
