...
async function main() {
  ...
  try {
    ...
    await pageA.click('[data-row="6"][data-col="4"]');
    await pageA.click('[data-row="5"][data-col="4"]');
    await pageA.waitForTimeout(900);

    await pageB.click('[data-row="3"][data-col="0"]');
    await pageB.click('[data-row="4"][data-col="0"]');
    await pageB.waitForTimeout(900);
    ...
    await pageB.click('[data-row="3"][data-col="8"]');
    await pageB.click('[data-row="4"][data-col="8"]');
    await pageB.waitForTimeout(900);

    await pageA.click('[data-row="4"][data-col="1"]');
    await pageA.click('[data-row="4"][data-col="4"]');

    await pageA.waitForFunction(() => {
      const state = JSON.parse(window.render_game_to_text());
      return state.checkSide === "black";
    }, null, { timeout: 10000 });
